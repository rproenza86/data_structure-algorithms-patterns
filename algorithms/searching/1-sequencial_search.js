 ...
 * the end of the list. 
 * 
 * This is called a sequential search, sometimes also called a linear search.
...
console.group('Generated array for the search:');
...
console.group('Searching process:');
    ...
    const searchResult = CArray.seqSearch(nums.dataStore, num);
