...
console.group('Generated array for the search minimum value:');
    console.log(nums.toString());
console.groupEnd();


console.group('Searching process:');

    console.log(`The minimum number in the array is "${nums.findMin()}".\n`);

    console.log(`The maximum number in the array is "${nums.findMax()}".\n`);
